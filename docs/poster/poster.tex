...
% -- Objective --
\begin{textblock}{0.295}(0.02, 0.271)
  \setlength{\baselineskip}{28pt}\setlength{\parskip}{6pt}%
  \pillhead{Objective}\vspace{18pt}\par
  {\fontsize{28}{36}\selectfont\setlength{\baselineskip}{38pt}%
    Build a portable Raspberry Pi file server with mTLS authentication, flexible permissions, and mDNS discovery. Deployable anywhere without cloud infrastructure or client software beyond a browser.\par}
\end{textblock}

% -- Problem Definition --
\begin{textblock}{0.295}(0.02, 0.39)
  \setlength{\baselineskip}{28pt}\setlength{\parskip}{6pt}%
  \pillhead{Problem Definition}\vspace{18pt}\par
  {\fontsize{28}{36}\selectfont\setlength{\baselineskip}{38pt}%
    There is no lightweight, portable and secure file sharing solution that provides multi-user access without external dependencies.\par}
\end{textblock}

% -- guest image --
\begin{textblock}{0.295}(0.02, 0.5)
  \includegraphics[width=\linewidth]{guest.png}
\end{textblock}
\begin{textblock}{0.295}(0.02, 0.74)
...
\begin{textblock}{0.295}(0.02, 0.778)
  ...
  \begin{itemize}\setlength{\itemsep}{6pt}
    \item Clients must authenticate with mTLS
    \item Full certificate lifecycle managed on-device
    \item Flexible access control
    \item mDNS for zero-config discovery
    \item Fully auditable self contained system.
  \end{itemize}}
\end{textblock}


\begin{textblock}{0.03}(0.91, 0.1547)
  \includegraphics[width=\linewidth]{9.PNG}
\end{textblock}
\begin{textblock}{0.03}(0.94, 0.1547)
  \includegraphics[width=\linewidth]{11.PNG}
\end{textblock}
\begin{textblock}{0.03}(0.97, 0.1547)
  \includegraphics[width=\linewidth]{12.PNG}
\end{textblock}\begin{textblock}{0.06}(0.125, 0.915)
...
\begin{textblock}{0.29}(0.684, 0.17)
  ...
  {\fontsize{28}{36}\selectfont\setlength{\baselineskip}{38pt}%
  \begin{itemize}\setlength{\itemsep}{6pt}
    \item 105 backend unit tests: auth, permissions, certificate lifecycle, path traversal
    \item Frontend enforced via ESLint, TypeScript strict mode, and Vite builds
    \item Three-workflow GitHub Actions CI: lint, type-check, tests, and Docker builds on every push
  \end{itemize}}
\end{textblock}
...
\end{textblock}
\begin{textblock}{0.29}(0.684, 0.61)
...
\begin{textblock}{0.29}(0.684, 0.845)
  ...
  {\fontsize{28}{36}\selectfont\setlength{\baselineskip}{38pt}%
    The team would like to thank Dr.\ Constantinos Kolias for proposing the project and providing guidance
    throughout the design process, and Dr.\ Terrance Soule for his support and guidance.\par}
\end{textblock}
